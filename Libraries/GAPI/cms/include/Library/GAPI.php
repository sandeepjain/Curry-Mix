...
class gapiAccountEntry
{
  ...
  public function __call($name,$parameters)
  {
    ...
    $property_key = self::array_key_exists_nc($name,$this->properties);
...
class gapiReportEntry
{
  ...
  public function __call($name,$parameters)
  {
    ...
    $metric_key = Library_GAPI::array_key_exists_nc($name,$this->metrics);
    ...
    $dimension_key = Library_GAPI::array_key_exists_nc($name,$this->dimensions);
